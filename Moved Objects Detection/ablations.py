...
ABLATIONS = [
    {"name": "all_lr1e-5", "strategy": "all", "lr": 1e-5, "epochs": 100},              # finetune all
    {"name": "all_lr5e-5", "strategy": "all", "lr": 5e-5, "epochs": 100},
    {"name": "backbone_lr1e-5", "strategy": "backbone_only", "lr": 1e-5, "epochs": 100},  # conv only
    {"name": "transformer_lr1e-5", "strategy": "transformer_only", "lr": 1e-5, "epochs": 100},  # transformer only
    {"name": "head_lr1e-5", "strategy": "head_only", "lr": 1e-5, "epochs": 100},      # cls/bbox head only
]
...
def run_ablation(cfg, checkpoints_root: Path, args):
    ...
    if proc.stdout:
        for line in proc.stdout:
            ...
            print(f"[{cfg['name']}] {line.rstrip()}", flush=True)
    proc.wait()
