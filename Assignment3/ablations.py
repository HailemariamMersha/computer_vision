...
ABLATIONS = [
    {"name": "all_lr1e-5", "strategy": "all", "lr": 1e-5, "epochs": 10},              # finetune all
    {"name": "all_lr5e-5", "strategy": "all", "lr": 5e-5, "epochs": 10},
    {"name": "backbone_lr1e-5", "strategy": "backbone_only", "lr": 1e-5, "epochs": 10},  # conv only
    {"name": "transformer_lr1e-5", "strategy": "transformer_only", "lr": 1e-5, "epochs": 10},  # transformer only
    {"name": "head_lr1e-5", "strategy": "head_only", "lr": 1e-5, "epochs": 10},      # cls/bbox head only
]
