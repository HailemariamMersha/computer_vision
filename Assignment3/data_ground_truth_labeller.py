...
if __name__ == "__main__":
    # Default to the provided dataset layout inside this repository.
    # Override these paths when running on HPC (e.g., /scratch/<netid>/cv_data_hw2).
    script_dir = os.path.dirname(os.path.abspath(__file__))
    base_dir = os.path.join(script_dir, 'cv_data_hw2')
    output_ann_dir = os.path.join(script_dir, 'matched_annotations')
    visual_dir = os.path.join(script_dir, 'visual_matches')
